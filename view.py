...
class CalculatorView:
    ...
    def frame(self):
        self.frame = Frame(self.root, bg= "#B7D8D9")
    ...
    def create_buttons(self):
        ...
        for text in button_texts:
            button = Button(self.frame, text=text, bg="#00E1FF", font=("Arial", 18), command=lambda t=text: self.controller.on_button_click(t), width=10, height=3)
